---
name: Focus Session Visual Feedback
about: Add animated visual feedback for the focus session widget in the dashboard.
title: "[Focus] Add Focus Session Visual Feedback To The Dashboard"
